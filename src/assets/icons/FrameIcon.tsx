...
const FrameIcon: React.FC<FrameIconProps> = ({ color = "#45888B", size = 20 }) => {
    return (
        <svg
            width={size}
            height={size}
