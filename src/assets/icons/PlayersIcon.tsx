...
const PlayersIcon = ({ width = 32, height = 32, className = "", active = false }: PlayersIconProps) => {
    return (
        <svg
            width={width}
            height={height}
        ...
        >
            ...
            <defs>
                <linearGradient id="paint0_linear_12487_16893" x1="13.9386" y1="25.0472" x2="-1.79788" y2="25.0472" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#C57339" />
                    <stop offset="0.494792" stopColor="#F1BFAC" />
                    <stop offset="1" stopColor="#CB9279" />
                </linearGradient>
                <linearGradient id="paint1_linear_12487_16893" x1="34.02" y1="26.9134" x2="18.2844" y2="26.9134" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#C1C1C1" />
                    <stop offset="0.4375" stopColor="white" />
                    <stop offset="1" stopColor="#D9D9D9" />
                </linearGradient>
                <linearGradient id="paint2_linear_12487_16893" x1="23.1251" y1="22.6447" x2="8.20216" y2="22.6694" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#D3A84C" />
                    <stop offset="0.484375" stopColor="#FFEC95" />
                    <stop offset="1" stopColor="#E6BE69" />
                </linearGradient>
                <linearGradient id="paint3_linear_12487_16893" x1="22.369" y1="5.90726" x2="9.10618" y2="5.93981" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#D3A84C" />
                    <stop offset="0.484375" stopColor="#FFEC95" />
                    <stop offset="1" stopColor="#E6BE69" />
                </linearGradient>
