...
import BackgroundItemCard from "@/components/backgroundItemCard/BackgroundItemCard";
    ...
    useEffect(() => {
        ...
        if (!hasAnimatedOnce && selectedTab === "BACKGROUND") {
            ...
            if (defaultRef) {
                ...
                setIndicatorStyle({ left: offsetLeft + offsetWidth * 0.1, width: offsetWidth * 0.8 });
            }
        }
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className={styles.modalContent}>
                <div className={styles.modalUpper}>
                    <div className={styles.modalHeader}>
                        ...
                        <div className={styles.stats}>
                            ...
                            <span className={styles.coinsAmount}>{coins.toLocaleString("en-US").replace(/,/g, " ")}</span>
                        </div>
                    </div>
                ...
                <div className={styles.tabContent}>
                    ...
                    {selectedTab === "FRAME" && (
                        <div className={styles.placeholder}>Frame content coming soon...</div>
                    )}

                    {selectedTab === "STICKER" && (
                        <div className={styles.placeholder}>Sticker content coming soon...</div>
                    )}
                </div>
            </div>
        </Modal>
